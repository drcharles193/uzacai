        ...
        <div className="flex border-b">
          <Tabs value={selectedTab} onValueChange={setSelectedTab} className="flex-1 flex border-r">
            <TabsList className="h-auto bg-transparent border-b-0 p-0">
              <TabsTrigger value="create" className="rounded-none py-3 px-4 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#689675] data-[state=active]:font-medium">
                Create Post
              </TabsTrigger>
              <TabsTrigger value="drafts" className="rounded-none py-3 px-4 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#689675] data-[state=active]:font-medium">
                Drafts
              </TabsTrigger>
              <TabsTrigger value="content" className="rounded-none py-3 px-4 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#689675] data-[state=active]:font-medium">
                Feed Content
              </TabsTrigger>
            </TabsList>
          </Tabs>
            ...
            <Tabs defaultValue="accounts" className="w-full">
              ...
              <TabsContent value="accounts" className="mt-0">
                ...
                <div className="space-y-2">
                  {connectedAccounts.map(account => <div key={account.account_name} className="flex items-center p-2 hover:bg-gray-50 rounded">
                      <input type="checkbox" id={account.account_name} className="h-4 w-4 mr-3" checked={selectedAccounts.includes(account.account_name)} onChange={() => handleAccountToggle(account.account_name)} />
                      <label htmlFor={account.account_name} className="flex items-center gap-2 cursor-pointer">
                        {account.platform === 'instagram' && <div className="w-6 h-6 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 flex items-center justify-center text-white text-xs">
                        ...
                        {account.platform === 'facebook' && <div className="w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs">
                        ...
                        {account.platform === 'twitter' && <div className="w-6 h-6 rounded-full bg-blue-400 flex items-center justify-center text-white text-xs">
                        ...
                        {account.platform === 'linkedin' && <div className="w-6 h-6 rounded-full bg-blue-700 flex items-center justify-center text-white text-xs">
