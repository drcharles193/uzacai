          ...
          <div className="flex-1 flex border-r">
            <TabsList className="h-auto bg-transparent border-b-0 p-0">
              <TabsTrigger 
                ...
                className={`rounded-none py-3 px-4 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#689675] data-[state=active]:font-medium ${selectedTab === 'create' ? 'border-b-2 border-[#689675] font-medium' : ''}`}
              >
                Create Post
              </TabsTrigger>
              <TabsTrigger 
                ...
                className={`rounded-none py-3 px-4 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#689675] data-[state=active]:font-medium ${selectedTab === 'drafts' ? 'border-b-2 border-[#689675] font-medium' : ''}`}
              >
                Drafts
              </TabsTrigger>
              <TabsTrigger 
                ...
                className={`rounded-none py-3 px-4 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-[#689675] data-[state=active]:font-medium ${selectedTab === 'content' ? 'border-b-2 border-[#689675] font-medium' : ''}`}
              >
                Feed Content
              </TabsTrigger>
            </TabsList>
        ...
        <div className="flex flex-1 h-[600px]">
          ...
          <div className="w-2/5 p-4">
            <div className="flex space-x-4 mb-6">
              <Button variant="outline" className={`rounded-full ${selectedTab === 'preview' ? 'bg-gray-100' : ''}`} onClick={() => setSelectedTab('preview')}>
                Post Preview
              </Button>
              <Button variant="outline" className={`rounded-full ${selectedTab === 'comments' ? 'bg-gray-100' : ''}`} onClick={() => setSelectedTab('comments')}>
                Comments
              </Button>
              <Button variant="outline" className={`rounded-full ${selectedTab === 'accounts' ? 'bg-gray-100' : 'bg-gray-100'}`} onClick={() => setSelectedTab('accounts')}>
                Accounts
              </Button>
            </div>
