...
const HowItWorks: React.FC = () => {
  ...
  return <section id="how-it-works" className="py-16 md:py-24 bg-secondary/30">
      <div className="container max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="relative">
          ...
          <div className="space-y-12 md:space-y-0 md:grid md:grid-cols-2 gap-x-12 gap-y-16 relative">
            {steps.map((step, index) => <div key={index} className={`relative animate-slide-up ${index % 2 === 0 ? 'md:pr-10' : 'md:pl-10 md:mt-24'}`} style={{
            animationDelay: `${index * 150}ms`
                ...
                <div className="glass-card rounded-xl p-6 md:p-8 h-full relative">
                  ...
                  {index < steps.length - 1 && <div className="flex justify-end md:hidden">
